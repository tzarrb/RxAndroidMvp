...
public class MyRecyclerView extends RecyclerView {
    ...
    public void onScrollStateChanged(int state) {
        ...
        L.i("onScrollStateChanged", "visibleItemCount" + visibleItemCount);
        L.i("onScrollStateChanged", "lastVisibleItemPosition" + lastVisibleItemPosition);
        L.i("onScrollStateChanged", "totalItemCount" + totalItemCount);
